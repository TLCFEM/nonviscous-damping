...
From an implementation perspective, this operation might be mitigated by applying the reciprocal of the scaling factor to the rest of the equation, namely matrices that already require scaling or vectors that are inexpensive to compute.
