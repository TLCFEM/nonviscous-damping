...
\begin{table}[ht!]
    ...
    \begin{tabular}{lccccll}
        \toprule
        section                                  &    $s_j$     &    $m_j$     &                    $\by_j$                    &       $\bh_j$       & cost                                                                    & remarks                                          \\ \midrule
        ...
        \secref{sec:v_dep_k}                     & $\mathbb{C}$ & $\mathbb{C}$ &    $\dot{\br}_{\bu}$ (linear: $\mb{K}\bv$)    &      $\mb{0}$       & \faStar\faStar\faStar\faStar\faStar[regular]                            & complex extension of \citep{Huang2019}           \\
        \secref{sec:v_dep_m}                     & $\mathbb{C}$ & $\mathbb{C}$ & $\dot{\br}_{\ba}$ (linear: $\mb{M}\dot{\ba}$) &      $\mb{0}$       & \faStar\faStar\faStar\faStar\faStar                                     & equiv. to \secref{sec:v_dep_k}                   \\ \midrule
        \secref{sec:u_dep} with \secref{sec:fix} & $\mathbb{C}$ & $\mathbb{C}$ &                  $\br_{\bu}$                  & $-m_j/s_j\br_{\bu}$ & \faStar\faStar\faStarHalf*\faStar[regular]\faStar[regular]              & alternative form, equiv. to \secref{sec:v_dep_k} \\
        \secref{sec:a_dep} with \secref{sec:fix} & $\mathbb{C}$ & $\mathbb{C}$ &                  $\br_{\ba}$                  & $-m_j/s_j\br_{\ba}$ & \faStar\faStar[regular]\faStar[regular]\faStar[regular]\faStar[regular] & alternative form, equiv. to \secref{sec:v_dep_k} \\ \midrule
        \multicolumn{7}{p{14cm}}{Note: the reported implementation cost is intended only to indicate the relative ranking among the formulations in the table, and does not represent a quantitative or absolute measure of computational expense.}                               \\ \bottomrule
    \end{tabular}
\end{table}
...
Its computational cost is lower than that of \eqsref{eq:v_final} but higher than that of \eqsref{eq:a_final}.
...
Consequently, this formulation is the least expensive among the three.
