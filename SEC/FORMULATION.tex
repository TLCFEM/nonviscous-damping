...
One shall note that the above equivalence is only valid under free vibration.
For forced vibration, the external load $\bp$ must be properly transformed to ensure the same equivalence.
...
The same also applies to $\sum\dfrac{m_j\Delta{}t}{2+s_j\Delta{}t}$, and thus $\bhat{K}$ is real--valued.
...
\begin{table}[ht!]
    ...
    \begin{tabular}{lccccll}
        ...
        \secref{sec:u_dep} with \secref{sec:fix} & $\mathbb{C}$ & $\mathbb{C}$ &                  $\br_{\bu}$                  & $-m_j/s_j\br_{\bu}$ & \faStar\faStar\faStarHalf*\faStar[regular]\faStar[regular]              & alt. form, equiv. to \secref{sec:v_dep_k} \\
        \secref{sec:a_dep} with \secref{sec:fix} & $\mathbb{C}$ & $\mathbb{C}$ &                  $\br_{\ba}$                  & $-m_j/s_j\br_{\ba}$ & \faStar\faStar[regular]\faStar[regular]\faStar[regular]\faStar[regular] & alt. form, equiv. to \secref{sec:v_dep_k} if free vibration \\ \midrule
...
Under free vibration, each one is equivalent to the others and all yield identical energy dissipation characteristics, provided that the parameters $s_j$ and $m_j$ are properly adjusted.
