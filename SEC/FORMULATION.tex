...
Assuming that the contributions of $\bu$, $\bv=\dot{\bu}$ and $\ba=\ddot{\bu}$ are separable, with no coupling among them, the resistance $\br$ can be split into three components
\begin{gather}
