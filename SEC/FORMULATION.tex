...
We now consider $\by_j=\mb{K}\bv$, the system becomes
...
In \eqsref{eq:u_final} and \eqsref{eq:v_final}, simply $\bz_{n+1}=\bp_{n+1}$.
In \eqsref{eq:a_final}, applying the same trapezoidal rule, one obtains
\begin{gather}\label{eq:discretised_z}
...
\begin{gather}
\begin{split}
\bz_{n+1}&=\left(1-\sum\dfrac{m_j}{s_j}\right)\bp_{n+1}+\sum\dfrac{2-s_j\Delta{}t}{2+s_j\Delta{}t}\bq_{j,n}+\sum\dfrac{m_j\Delta{}t}{2+s_j\Delta{}t}\bp_n+\sum\dfrac{m_j\Delta{}t}{2+s_j\Delta{}t}\bp_{n+1}\\
&=\left(1-\sum\dfrac{m_j}{s_j}+\sum\dfrac{m_j\Delta{}t}{2+s_j\Delta{}t}\right)\bp_{n+1}+\sum\dfrac{2-s_j\Delta{}t}{2+s_j\Delta{}t}\bq_{j,n}+\sum\dfrac{m_j\Delta{}t}{2+s_j\Delta{}t}\bp_n.
\end{split}
\end{gather}
...
\begin{breakablealgorithm}
    ...
    \begin{algorithmic}
        ...
        \State \faMicrochip~compute effective load if needed $\bz$
