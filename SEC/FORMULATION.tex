...
One shall see that in essence this formulation applies an energy-dissipating force $\bbf_j$ that is the filtered version of the stiffness proportional viscous damping force $\mb{K}\bv$.
