...
\begin{table}[ht!]
    ...
    \begin{tabular}{lccccll}
        \toprule
                                                  ...
                                                  & $\mathbb{C}$ & $\mathbb{C}$ &                     $\bu$                     &    $-m_j/s_j\bu$    & \faStar\faStarHalf*\faStar[regular]\faStar[regular]     & general, guaranteed dissipation                                     \\
                                                  & $\mathbb{C}$ & $\mathbb{C}$ &                     $\bv$                     &      $\mb{0}$       & \faStar\faStarHalf*\faStar[regular]\faStar[regular]     & identical to \citep{Chang2024}, guaranteed dissipation                      \\
                                                  & $\mathbb{C}$ & $\mathbb{C}$ &                     $\ba$                     &    $-m_j/s_j\ba$    & \faStar\faStarHalf*\faStar[regular]\faStar[regular]     & general, guaranteed dissipation                                     \\ \midrule
    ...
    \end{tabular}
\end{table}
The proposed damping formulations can be applied at both the global and the element level.
...
\begin{enumerate}
    ...
    \item The reciprocal formulations are equivalent mathematically.
          ...
          In global time integration methods that express the equation of motion in terms of $\bu$, $\mb{M}$ is already scaled by a scalar factor; therefore, the proposed contribution can be included with merely one additional scalar multiplication.
\end{enumerate}
