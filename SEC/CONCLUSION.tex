...
The presented nonviscous damping formulations are implemented in the open-source finite element analysis framework \texttt{suanPan} \citep{Chang2026}. All numerical examples and the relevant scripts are available in this repository\footnote{https://github.com/TLCFEM/nonviscous-damping}.
